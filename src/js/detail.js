...
function renderStoreInfo(store) {
    ...
    storeContactEl.textContent = store.contacts.phone ?? 'Tidak Ada Kontak'
    storeOpeningTimesEl.textContent = `${store.openingTimes.days} | ${store.openingTimes.hours}` ?? 'Tidak Diketahui'
    storeTimesDetail.textContent = `${store.openingTimes.days} | ${store.openingTimes.hours}` ?? 'Tidak Diketahui'
    ...
    storeLocationEl.textContent = store.location.address ?? 'Tidak Diketahui'
